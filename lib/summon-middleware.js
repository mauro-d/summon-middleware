...
/**
 *
 * @param {(Function|Function[])} middleware A middleware or an array of
 * middlewares to handle dynamically.
 * @param {Function} predicate A function that returns a boolean value. This
 * function represents the condition for which the middlewares have to be used
 * or not.
 * @returns {(Function|Function[])} A single middleware or an array of
 * middlewares.
 * @version 2.0.2
