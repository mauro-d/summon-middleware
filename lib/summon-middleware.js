...
/**
 *
 * @param {(Function|Function[])} middleware The express or connect middleware to dynamically handle
 ...
 * @returns {(Function|Function[])} The express or connect middleware
 * @version 1.0.0
...
module.exports = function summonMiddleware(middleware, predicate) {
    ...
    if (!(predicate && typeof predicate === 'function')) {
        throw new SummonMiddlewareError('The predicate parameter must be a function');
    }
    ...
    if (typeof middleware === 'function') {
        ...
        if (middleware.length === 0) {
            throw new SummonMiddlewareError('The middleware parameter must be a function' +
                ' or an array of functions. More info at: http://expressjs.com');
        }
        var wrappedMiddlewares = [];
        middleware.forEach(m => {
            if (!(m && typeof m === 'function')) {
                throw new SummonMiddlewareError('The middleware parameter must contain' +
                    ' only functions.');
            }
